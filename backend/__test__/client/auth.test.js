...
beforeAll(async function (){
  try {
    ...
    insertedServer = await Server.insertOne({
      userId: 'Account',
      server: 'back-end',
      id: '674d3583c75ca40a1a869921'
    });
    const FriendList = dbInstance.collection('FriendLists');
    insertedFriendList = await FriendList.insertOne({
      userId: '674d3583c75ca40a1a869922',
      userIdb: '674d3583c75ca40a1a869923',
      id: '674d3583c75ca40a1a869924'
    });
    const user = dbInstance.collection('users');
    insertedUser = await user.insertOne({
      username: 'Maddison.Lockman50',
      password: '2Ni_QtLS1K4eqmA',
      email: 'Alexa.Boehm@gmail.com',
      name: 'Eric Kuhn PhD',
      FriendList: '674d3583c75ca40a1a869943',
      userType: 594,
      server: '674d3583c75ca40a1a869944',
      mobileNo: '(950) 649-7139',
      resetPasswordLink: {},
      loginRetryLimit: 821,
      loginReactiveTime: '2025-07-25T16:50:23.881Z',
      ssoAuth: {
        githubId: 'SDD',
        linkedinId: 'Markets',
        googleId: 'Lead',
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Micheal_Rippin',
        'password':'SS0q7YUOVYHkx5J',
        'email':'Mireya87@gmail.com',
        'name':'Bessie Bergnaum',
        'FriendList':insertedFriendList.insertedId,
        'userType':authConstant.USER_TYPES.User,
        'server':insertedServer.insertedId,
        'mobileNo':'(785) 046-7129',
        'ssoAuth':{
          'githubId':'Steel',
          'linkedinId':'enhance',
          'googleId':'copying',
          'facebookId':'Incredible'
        },
