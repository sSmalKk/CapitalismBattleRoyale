...
beforeAll(async function (){
  try {
    ...
    insertedUser = await User.insertOne({
      username: 'Miracle_Satterfield23',
      password: 'dxIg0W62kqjYUOy',
      email: 'Hilbert25@hotmail.com',
      name: 'Jaime Gerhold',
      userType: 548,
      x: 517,
      y: 361,
      ...
      ry: 'model',
      rz: 'Mission',
      mobileNo: '(482) 080-8999',
      resetPasswordLink: {},
      loginRetryLimit: 185,
      loginReactiveTime: '2025-02-16T06:48:03.522Z',
      id: '6764c00903758a018b8b4c83'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a User', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Tess.DuBuque85',
        'password':'iuaT75ddTbr2wFU',
        'email':'Percival17@gmail.com',
        'name':'Peggy Paucek',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let User = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'Percival17@gmail.com', });
