...
beforeAll(async function (){
  try {
    ...
    insertedUser = await User.insertOne({
      username: 'Claire66',
      password: 'ayP5kN01lhOO2QG',
      email: 'Lucile.Kassulke@yahoo.com',
      name: 'Valerie Parker',
      userType: 82,
      x: 747,
      y: 561,
      ...
      ry: 'grey',
      rz: 'USB',
      mobileNo: '(317) 991-4081',
      resetPasswordLink: {},
      loginRetryLimit: 341,
      loginReactiveTime: '2025-08-26T19:12:04.071Z',
      id: '6764c00903758a018b8b4c4a'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a User', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Pink.Emard80',
        'password':'70emqZHZ2nbs1Bk',
        'email':'Shana_Torphy@yahoo.com',
        'name':'Dr. Terri Heaney',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let User = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Shana_Torphy@yahoo.com', });
