...
beforeAll(async function (){
  try {
    ...
    insertedServer = await Server.insertOne({
      userId: 'green',
      server: 'Shirt',
      id: '674d3583c75ca40a1a8697ef' 
    });
    const FriendList = dbInstance.collection('FriendLists');
    insertedFriendList = await FriendList.insertOne({
      userId: '674d3583c75ca40a1a8697f0',
      userIdb: '674d3583c75ca40a1a8697f1',
      id: '674d3583c75ca40a1a8697f2'
    });
    const user = dbInstance.collection('users');
    insertedUser = await user.insertOne({
      username: 'Brigitte_Robel62',
      password: '7FdoNJmxGqELoTl',
      email: 'Lamont.Hackett@gmail.com',
      name: 'Mrs. Terrell Wilderman',
      FriendList: '674d3583c75ca40a1a869811',
      userType: 88,
      server: '674d3583c75ca40a1a869812',
      mobileNo: '(607) 960-6336',
      resetPasswordLink: {},
      loginRetryLimit: 16,
      loginReactiveTime: '2025-11-19T13:47:40.937Z',
      ssoAuth: {
        githubId: 'Rubber',
        linkedinId: 'deposit',
        googleId: 'Tasty',
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Shawn.Witting',
        'password':'fbP1KJYCN2HvjKE',
        'email':'Dwight_Quigley@yahoo.com',
        'name':'Eleanor Kuvalis',
        'FriendList':insertedFriendList.insertedId,
        'userType':authConstant.USER_TYPES.Admin,
        'server':insertedServer.insertedId,
        'mobileNo':'(806) 377-0126',
        'ssoAuth':{
          'githubId':'bypass',
          'linkedinId':'hacking',
          'googleId':'Metal',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Dwight_Quigley@yahoo.com', });
